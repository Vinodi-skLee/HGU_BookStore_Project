...
<body>
	...
	<form action="addok" method="post">
		<table id="add">
			<tr><td>Major</td><td><select path="major"><optgroup label="전공"><option value="GLS">GLS</option><option value="어문">어문</option><option value="경경">경경</option><option value="법">법</option><option value="컴케">컴케</option><option value="공시">공시</option><option value="기계">기계</option><option value="콘디">콘디</option><option value="생명">생명</option><option value="전전">전전</option><option value="상사">상사</option><option value="ICT">ICT</option></optgroup><optgroup label="교양"><option value="교양">교양</option><option value="기타">기타</option></optgroup><select></td></tr>
